...
public class UsersFeedService {
    ...
    private Map<String, MockUserData> initializeMockUserData() {
        ...
        // Admin user
        data.put("admin@produs.com", new MockUserData("admin@produs.com", "Admin", "User", User.UserRole.ADMIN));
        
        data.put("owner@produs.com", new MockUserData("owner@produs.com", "Product", "Owner", User.UserRole.PRODUCT_OWNER));
        data.put("team@produs.com", new MockUserData("team@produs.com", "Team", "Manager", User.UserRole.TEAM_MANAGER));
        data.put("specialist@produs.com", new MockUserData("specialist@produs.com", "Service", "Specialist", User.UserRole.SPECIALIST));
        data.put("advisor@produs.com", new MockUserData("advisor@produs.com", "Platform", "Advisor", User.UserRole.ADVISOR));
