...
public final class LoomAIToolAllowlist {
    ...
    public static List<ToolDefinition> tools() {
        return List.of(
                ...
                read("produs.package.inspect", "Inspect an authorized product plan package."),
                read("produs.workspace.inspect", "Inspect an authorized product workspace."),
                mutation("produs.productization_project.create", "Create the owner-approved initial product from an active AI product creation intent.", false),
                mutation("produs.requirement.submit", "Submit a product requirement after explicit user confirmation."),
                ...
                mutation("produs.workspace.create", "Create a product workspace from a confirmed package/cart."),
