...
function LinearProgressWithLabel({ value, ...other }: LinearProgressProps) {
  return (
    ...
    >
      ...
      >
        <LinearProgress value={value || 0} {...other} />
      </Box>
      <Box
        sx={{
          minWidth: 35,
...
const Profile = () => {
  ...
  const rows = [
    createData('Full Name', ':', user?.firstName ? `${user.firstName} ${user.lastName}` : user?.email),
              ...
              <Grid container spacing={2}>
                <Grid size={{ xs: 12 }}>
                  <Typography variant="body2">
                    Hello,I’m Anshan Handgun Creative Graphic Designer & User Experience Designer
            ...
            <SubCard title="Skills">
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12 }}>
                  ...
                  <LinearProgressWithLabel
                    color="primary"
                    aria-label="Graphic design skill progress"
                    variant="determinate"
                    value={80}
                  />
                </Grid>
