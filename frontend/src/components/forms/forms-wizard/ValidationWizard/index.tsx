...
const ValidationWizard = () => {
  ...
  const [paymentData, setPaymentData] = React.useState<PaymentData>({ cardName: undefined, cardNumber: undefined });
            ...
            <Stack direction="row" justifyContent="flex-end">
              <AnimateButton>
                <Button
                  ...
                  onClick={() => {
                    setShippingData({});
                    setPaymentData({ cardName: undefined, cardNumber: undefined });
                    setActiveStep(0);
                  }}
                  sx={{ my: 3, ml: 1 }}
                >
