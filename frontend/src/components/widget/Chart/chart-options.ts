...
export const TotalLineCardChartOptions1: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Total Sales',
      },
    },
    marker: {
      show: false,
...
export const TotalLineCardChartOptions2: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Total Status',
      },
    },
    marker: {
      show: false,
...
export const SalesLineCardChartOptions: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Sales/Order Per Day',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions3: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Products :',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions4: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Analytics ',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions5: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Timeout ',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions6: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'View ',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions7: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Session ',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions8: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Avg. Session ',
      },
    },
    marker: {
      show: false,
...
export const SeoChartCardOptions9: ChartProps = {
  ...
  tooltip: {
    ...
    y: {
      title: {
        formatter: (_seriesName: string) => 'Bounce ',
      },
    },
    marker: {
      show: false,
