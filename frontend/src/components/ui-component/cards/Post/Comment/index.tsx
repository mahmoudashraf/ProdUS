...
const Comment = ({
  ...
  const onSubmit = async (reply: CommentData, _e: any) => {
    handleChangeReply();
  ...
  return (
    <>
                  ...
                  <Button
                    ...
                    startIcon={
                      <ThumbUpAltTwoToneIcon
                        color={
                          comment.data?.likes && comment.data?.likes.like ? 'secondary' : 'inherit'
                        }
                      />
                    }
                  >
      ...
      <Collapse in={openReply} sx={{ width: '100%' }}>
        {openReply && (
          <Grid size={{ xs: 12 }} sx={{ pl: { xs: 1, sm: 3 }, pt: 3 }}>
            <Box
              sx={{
                ml: 4.25,
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)}>
                <Grid container spacing={2} alignItems="flex-start">
                  ...
                  <Grid size={{ xs: 12 }} sx={{ minWidth: 0, mt: 1 }}>
