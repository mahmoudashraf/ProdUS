...
import { Button, Container, Grid, Stack, Typography, CardMedia  } from '@mui/material';
...
const CustomizeSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Grid size={{ xs: 12, md: 6 }} sx={{ img: { width: '100%' } }}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Grid container spacing={2.5}>
            <Grid size={{ xs: 12 }}>
              ...
              >
                Kiwi has made it easy for developers of any skill level to use their product.
              </Typography>
            </Grid>
            <Grid size={{ xs: 12 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Grid container spacing={2.5}>
                <Grid size={{ xs: 12 }}>
                  ...
                  >
                    Streamlining the development process and saving you time and effort in the
                ...
                <Grid size={{ xs: 12 }}>
                  ...
                  <Typography sx={listSX}>
                    <IconCircleCheck size={20} />A theme that can be easily configured on a single
                    page.
                  </Typography>
                  <Stack direction="row">
                    <AnimateButton>
                      <Button
                        ...
                        variant="contained"
                        component={Link}
                        href="https://www.figma.com/file/2u2TmauA6lanVMYiywzS1o/kiwi-figma-v3.0?node-id=0%3A1"
                        target="_blank"
                      >
                        Explore Figma
                      </Button>
