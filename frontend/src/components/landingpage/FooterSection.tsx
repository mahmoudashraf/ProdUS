              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Stack spacing={{ xs: 2, md: 5 }}>
                  ...
                  <Typography variant="body2" color={textColor}>
                    Kiwi React is a dashboard template that utilizes the Material-UI framework and
                    the React JavaScript library. It offers a range of features and customization
                    options to help you create a powerful and user-friendly admin panel.
                  </Typography>
                </Stack>
              </Grid>
                  ...
                  <Grid size={{ xs: 6, sm: 3 }}>
                    <Stack spacing={{ xs: 3, md: 5 }}>
                      ...
                      <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                        ...
                        <FooterLink
                          href="https://codedthemes.gitbook.io/kiwi/"
                          target="_blank"
                          underline="none"
                        >
                          Documentation
                        ...
                        <FooterLink
                          href="https://codedthemes.gitbook.io/kiwi/changelog"
                          target="_blank"
                          underline="none"
                        >
                          Change Log
