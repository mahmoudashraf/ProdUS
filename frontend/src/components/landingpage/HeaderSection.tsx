      ...
      >
        <Grid size={{ xs: 12, md: 5 }}>
          <Grid container spacing={5}>
            ...
            <Grid size={{ xs: 12 }} sx={{ mt: -2.5, textAlign: { xs: 'center', md: 'left' } }}>
              <motion.div
                initial={{ opacity: 0, translateY: 550 }}
                animate={{ opacity: 1, translateY: 0 }}
              ...
              >
                ...
                >
                  Kiwi is React based Dashboard template which helps you to build faster and
        ...
        <Grid size={{ xs: 12, md: 7 }} sx={{ display: { xs: 'none', md: 'flex' } }}>
          <Box sx={{ position: 'relative', mt: 8.75, zIndex: 9 }}>
            <HeaderImage src={dashboard} alt="Kiwi" />
            <Box
              sx={{
                position: 'absolute',
                top: { md: -35, lg: -110 },
            ...
            >
              <motion.div
                ...
                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.2 }}
              >
                <HeaderAnimationImage src={widget1} alt="Kiwi" />
              </motion.div>
            </Box>
            <Box
              sx={{
            ...
            >
              <motion.div
                ...
                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.4 }}
              >
                <HeaderAnimationImage src={widget2} alt="Kiwi" />
              </motion.div>
            </Box>
          </Box>
