...
// Note: Migration hooks removed - using pure Context API
import MainCard from 'ui-component/cards/MainCard';
import Chip from 'ui-component/extended/Chip';

// Using Context API + React Query
...
const CustomerList = () => {
  ...
  // Get customers data via modern Context API
  const customers = customerContext.state.customers;
  
  React.useEffect(() => {
    // Use modern Context API for customer management
    try {
                ...
                return (
                  ...
                  >
                    <TableCell
                      padding="checkbox"
                      sx={{ pl: 3 }}
                      onClick={_event => handleClick(_event, row.name)}
                    >
                      <Checkbox
                        color="primary"
