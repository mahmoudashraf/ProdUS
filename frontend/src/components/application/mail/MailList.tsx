...
const MailList = ({
  ...
  const handleChangePage: MailListHeaderProps['handleChangePage'] = (_event, newPage) => {
    setPage(newPage);
  };

  const handleChangeRowsPerPage: MailListHeaderProps['handleChangeRowsPerPage'] = _event => {
      ...
      <Grid container spacing={matchDownSM ? 3 : 1}>
        ...
        <Grid size={{ xs: 12 }}>
          {data.length ? (
            <MainCard
              content={false}
              sx={{ bgcolor: theme.palette.mode === 'dark' ? 'dark.800' : 'grey.50' }}
            >
              {/* table */}
              <TableContainer>
                <Table
                          ...
                          >
                            <TableCell>
                              <Checkbox
                                ...
                                color="primary"
                                onChange={_event => handleClick(_event, row.profile.name)}
                                inputProps={{
                              ...
                              <Checkbox
                                ...
                                checked={row.starred}
                                onChange={_event => handleStarredChange(_event, row)}
                                size="small"
                              />
                              <Checkbox
                                ...
                                onChange={_event => handleImportantChange(_event, row)}
                                size="small"
                              />
                            </TableCell>
                            <TableCell
        ...
        <Grid size={{ xs: 12 }} sx={{ pt: '0 !important', display: { xs: 'block', sm: 'none' } }}>
          {/* table pagination */}
          <TablePagination
            rowsPerPageOptions={[]}
            component="div"
