          ...
          <Grid container spacing={gridSpacing}>
              ...
              >
                <CardContent>
                  <Grid container alignItems="center" justifyContent="space-between">
                    ...
                    <Grid>
                      <AnimateButton>
                        <CopyToClipboard text="KIWI50" onCopy={() => setDiscount('KIWI50')}>
                          <Button
                            variant="outlined"
                            color="secondary"
                            size="small"
            ...
            <Grid size={{ xs: 12 }}>
              <Grid container spacing={3} alignItems="center">
                ...
                <Grid size={6} sx={{ display: { xs: 'block', sm: 'none' } }}>
                  <AnimateButton>
                ...
                <Grid size={{ xs: 12, sm: 8 }}>
                  <Stack spacing={0.25}>
                    ...
                    <Typography variant="caption">
                      When you subscribe to the unlimited consultation plan on kiwi.
                    </Typography>
                  </Stack>
                </Grid>
                <Grid size={{ xs: 12, sm: 2 }} sx={{ display: { xs: 'none', sm: 'block' } }}>
                  <AnimateButton>
                    <CopyToClipboard text="SUB150" onCopy={() => setDiscount('SUB150')}>
                      <Button
                        variant="outlined"
