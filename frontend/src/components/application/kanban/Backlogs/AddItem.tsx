...
const AddItem = ({ open, handleDrawerOpen, storyId }: Props) => {
  ...
  const { profiles, columns, userStory, items } = kanbanContext.state;
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      // Use Context API instead of Redux dispatch
      kanbanContext.addItem(values.columnId, columns, item, items, storyId, userStory);
