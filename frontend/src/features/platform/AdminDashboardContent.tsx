        ...
        {canManageOperations && (
          <Surface>
            ...
            <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
              <Button variant="outlined" size="small" onClick={onRunSlaScan} disabled={isRunningSlaScan}>
                Run SLA
              </Button>
              <Button variant="outlined" size="small" onClick={onDispatchDeliveries} disabled={isDispatchingDeliveries}>
                Dispatch
              </Button>
            </Stack>
            {deliveryConfig && (
