  ...
  return (
    <Box sx={{ p: 1.5, borderRadius: 1, border: '1px solid', borderColor: `${statusAccent}30`, bgcolor: `${statusAccent}0d` }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mt: 1, lineHeight: 1.55 }}>
        {readiness?.summary || (canStartWorkspace ? 'Planning has enough scope to become a product workspace.' : 'Choose the services and delivery support that make the first workspace actionable.')}
      </Typography>
    </Box>
  );
}
