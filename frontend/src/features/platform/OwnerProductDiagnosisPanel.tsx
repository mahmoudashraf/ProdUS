...
import { ProductDiagnosis, ProductProfile, ServiceModule } from './types';
  ...
  return (
    <Surface sx={{ background: 'linear-gradient(135deg, #ffffff 0%, #f7fbff 100%)' }}>
      <SectionTitle
        ...
        action={
          <PastelChip
            label={latestDiagnosis ? `${latestDiagnosis.findings.length} findings` : 'Not run'}
        ...
        <Box component="form" onSubmit={diagnosisForm.handleSubmit(onCreateDiagnosis)}>
          <Stack spacing={1.25}>
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
              Turn the owner brief into a practical launch-readiness view. This is deterministic and
              stored; AI explanation only runs when you ask for it.
            </Typography>
            <TextField
              size="small"
              label="Launch goal"
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  />
                  <PastelChip
                    label={latestDiagnosis.aiExecuted ? 'AI explanation run' : 'No AI run'}
              ...
              {latestDiagnosis.diagnosisSource === 'SCANNER_READINESS' && (
                ...
                >
                  <MetricTile
                    ...
                    detail="Critical/high scanner findings"
                    accent={
                      latestDiagnosis.topBlockerCount || 0 ? appleColors.red : appleColors.green
                    }
                  ...
                  <MetricTile
                    ...
                    detail="Need human classification"
                    accent={
                      latestDiagnosis.unmappedFindingCount || 0
                        ? appleColors.amber
                        : appleColors.green
                    }
                    icon={<InfoOutlined />}
                    ...
                    >
                      ...
                      <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mt: 1 }}>
                        ...
                        {finding.recommendedModuleName && (
                          <PastelChip
                            label={finding.recommendedModuleName}
                        ...
                        >
                          {finding.ownerDecision && (
                            ...
                            >
                              ...
                              <Typography
                                variant="body2"
                                sx={{ fontWeight: 800, lineHeight: 1.45 }}
                              >
                                {finding.ownerDecision}
                              </Typography>
                            </Box>
