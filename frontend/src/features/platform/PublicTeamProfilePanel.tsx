...
export default function PublicTeamProfilePanel({
  ...
  const actionButtons = (
    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
      ...
      >
        {!isLoggedIn ? 'Sign in to attach team' : canUseProjectCart ? (inPlan ? 'In Planning' : 'Attach team to Planning') : 'Open dashboard'}
      </Button>
  ...
  return (
    <Stack spacing={2.5}>
      <PageHeader
        title="Team Profile"
        description="Evaluate whether this delivery team belongs in Planning."
      />
