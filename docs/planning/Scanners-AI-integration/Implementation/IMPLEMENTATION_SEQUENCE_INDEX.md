...
- `LOOMAI_PRODUCT_AI_INTEGRATION_PLAN.md` defines the ProdUS product AI functionality, direct-runtime request/response contract, context enrichment plan, action schema, and remaining LoomAI integration gaps.
