...
- When a temporary URL is available, ProdUS does not send document text excerpts to LoomAI; LoomAI must open the temporary URL or report that the document was not used.
