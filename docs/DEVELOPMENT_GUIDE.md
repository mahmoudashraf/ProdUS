...
LOOMAI_ASSERTION_DEPLOYMENT_ID=
...
- For the backend LoomAI MCP discovery endpoints (`/mcp`, `/loomai/tool-allowlist`), send `X-MCP-API-KEY: <PRODUS_MCP_API_KEY>` when `PRODUS_MCP_REQUIRE_AUTH=true`.
